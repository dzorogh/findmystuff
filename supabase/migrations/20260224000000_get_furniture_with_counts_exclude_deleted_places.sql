-- Счётчик мест в мебели: только места, чьё текущее расположение — эта мебель (последний переход), и только неудалённые места.
-- Единственная версия: 8 параметров (filter_tenant_id). 7-параметровая удалена в 20260221120000.
