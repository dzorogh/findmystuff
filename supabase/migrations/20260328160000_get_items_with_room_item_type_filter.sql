-- Добавить фильтр по категории вещи (item_type_id) в get_items_with_room

drop function if exists public.get_items_with_room(text, boolean, integer, integer, text, bigint, boolean, text, text, bigint, bigint);
...
grant execute on function public.get_items_with_room(text, boolean, integer, integer, text, bigint, boolean, text, text, bigint, bigint, bigint) to anon, authenticated;
