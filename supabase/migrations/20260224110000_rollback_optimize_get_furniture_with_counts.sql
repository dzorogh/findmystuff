-- Откат 20260224100000_optimize_get_furniture_with_counts: удаление индекса и восстановление исходной функции.

drop index if exists public.idx_transitions_place_id_dest_type_created_at;
