-- Добавление параметров сортировки в get_places_with_room
...
grant execute on function public.get_places_with_room(text, boolean, integer, integer, text, text) to anon, authenticated;
