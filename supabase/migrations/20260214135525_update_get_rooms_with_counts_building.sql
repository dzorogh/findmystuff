-- Добавить filter_building_id и building_id, building_name в get_rooms_with_counts
...
grant execute on function public.get_rooms_with_counts(text, boolean, integer, integer, text, text, boolean, boolean, boolean, bigint) to anon, authenticated;
