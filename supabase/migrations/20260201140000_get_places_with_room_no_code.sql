-- Пересоздать get_places_with_room без entity_type_code
...
grant execute on function public.get_places_with_room(text, boolean, integer, integer) to anon, authenticated;
